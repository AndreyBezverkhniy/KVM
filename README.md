...
Левый/правый инкремент/декремент, +, -, * работают как в других языках. Правда левые инкременты и декременты возвращают именно число.
...
Левый операнд операторов = и Х= обязан быть переменной. Возвращаемый результат - число, новое значение переменной.
...
Все функции в каждом модуле сохраняются в ассоциативный массив, где ключ - сигнатура функции, а значение - массив имён аргументов функции и тело функции (к инструкций).
